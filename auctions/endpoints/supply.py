...
def get_current_session(
    supply_service: SupplyService = Provide["supply_service"],
    supply_session_serializer: SupplySessionSerializer = Provide["supply_session_serializer"],
) -> JsonResponse:
...
@inject
def start_session(
    item_types_repository: ItemTypesRepository = Provide["item_types_repository"],
    images_repository: ImagesRepository = Provide["images_repository"],
    supply_service: SupplyService = Provide["supply_service"],
    supply_session_serializer: SupplySessionSerializer = Provide["supply_session_serializer"],
) -> JsonResponse:
    args = parser.parse(
...
def process_item(
    id_: int,
    items_repository: ItemsRepository = Provide["items_repository"],
    supply_service: SupplyService = Provide["supply_service"],
